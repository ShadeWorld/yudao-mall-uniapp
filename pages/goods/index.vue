<template>
  <view>
    <s-layout :onShareAppMessage="shareInfo" navbar="goods">
      ...
      <!-- 下架/售罄提醒 -->
      <s-empty v-else-if="state.goodsInfo === null" text="商品不存在或已下架" icon="/static/soldout-empty.png"
               showAction
      ...
      <block v-else>
        <view class="detail-swiper-selector">
          ...
          <!-- 规格与数量弹框 -->
          <s-select-sku v-if="state.goodsInfo.categoryId === 3" :goodsInfo="state.goodsInfo"
